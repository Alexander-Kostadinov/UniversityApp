...
<form action="add_student.php" method="post" name="add_student">
	...
	<input id="add-btn" type="button" value="Добави" class="button" onClick="validate_form()"
		style="margin-top: 20px; font-size: 16px;">
	<input id="cancel-btn" type="reset" value="Отказ" class="button" style="margin-top: 20px; font-size: 16px;">
</body>
</html>
